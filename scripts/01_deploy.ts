...
import { DemoNFT, DemoNFT__factory, ERC6551Registry, ERC6551Registry__factory } from "../typechain-types";
...
async function main() {
  ...
  const demoNFT:DemoNFT = await DemoNFT.deploy("Sp Test 1","SPT1");
